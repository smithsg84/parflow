...
# Computational Grid
#---------------------------------------------------------
pfset ComputationalGrid.NX                      [expr 18*$size]
pfset ComputationalGrid.NY                      [expr 15*$size]
pfset ComputationalGrid.NZ                      [expr 8*$size]

pfset ComputationalGrid.Lower.X                -10.0
pfset ComputationalGrid.Lower.Y                 10.0
pfset ComputationalGrid.Lower.Z                  1.0

set   UpperX                              [expr 8.8888888888888893*18.0]
set   UpperY                              [expr 10.666666666666666*15.0]
set   UpperZ                              [expr 1.0*8]
